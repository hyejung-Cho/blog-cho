...
export default function ReadMd() {
    ...
    const smarkdown = '최근 몇 년간 인공지능(AI)과 자연어 처리(NLP) 분야는 급격한 발전을 이루었습니다. 그 중심에는 OpenAI의 GPT-3와 같은 대규모 언어 모델들이 있습니다. 이러한 모델들은 개발자들의 일상 업무와 개발 프로세스를 혁신적으로 변화시키고 있습니다. 이 글에서는 GPT 시대에 개발자들이 겪고 있는 변화와 앞으로의 전망에 대해 살펴보겠습니다.'
